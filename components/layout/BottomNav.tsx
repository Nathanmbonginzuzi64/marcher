...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-gray-100 bg-white/95 backdrop-blur-lg safe-bottom">
        ...
        {navItems.map(({ href, label, icon: Icon, badge }) => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <span className="absolute -bottom-0.5 h-0.5 w-6 rounded-full bg-emerald-500" />
              )}
            </Link>
          );
        })}
